-- Primeiro, remover as funções existentes para poder recriar
...
-- Recriar a função calculate_product_total_cost com multiplicador direto
...
-- Recriar a função update_perfume_margin
