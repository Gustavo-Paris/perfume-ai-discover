-- Corrigir funções removendo referência à coluna updated_at que não existe
...
-- Corrigir função de correção individual também
...
BEGIN
  ...
  -- Atualizar margem (removido updated_at)
  UPDATE perfumes 
