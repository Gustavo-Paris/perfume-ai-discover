-- Primeiro fazer DROP da função antiga e criar a nova corrigida
DROP FUNCTION IF EXISTS public.recalculate_all_perfume_prices();

-- Criar nova função que usa diretamente o multiplicador
...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- CORREÇÃO: usar diretamente o multiplicador
