-- Corrigir a função auto_recalculate_perfume_prices
-- O problema está na linha onde converte margin novamente
...
BEGIN
  ...
  -- CORREÇÃO: perfume_margin JÁ É UM MULTIPLICADOR, não precisa converter
  ...
  LOOP
    ...
    ELSE
      packaging_cost := frasco_10ml_cost + etiqueta_cost; -- Default para outros tamanhos
    END IF;
