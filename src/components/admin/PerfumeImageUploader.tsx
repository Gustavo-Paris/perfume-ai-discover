...
const PerfumeImageUploader = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Upload das imagens pré-identificadas */}
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            <Upload className="h-5 w-5" />
            Upload de Imagens Pré-identificadas
          </CardTitle>
          <CardDescription>
            Faça upload das imagens que foram identificadas anteriormente para o bucket do Supabase
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
