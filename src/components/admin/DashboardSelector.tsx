...
import { BarChart3, DollarSign, Package, ShoppingCart, TrendingUp, LineChart } from 'lucide-react';

export type DashboardType = 'overview' | 'financial' | 'orders' | 'inventory' | 'performance' | 'analytics';
